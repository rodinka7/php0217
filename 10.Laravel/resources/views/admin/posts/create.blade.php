  ...
  <div class="content-middle">
    <div class="content-head__container">
      <div class="content-head__title-wrap">
        <div class="content-head__title-wrap__title bcg-title">Новый пост</div>
      </div>
    ...
    <div class="content-main__container">
      <div class="product-container">
        <form class="create-container__form" method="post" action="/admin/create/post" enctype="multipart/form-data">
          {{ csrf_field() }}
            ...
            <input type="text" class="edit-container__form__input" name="title" placeholder="Введите название поста">
          </div>
          <div class="product-container__content-text__price">
           <button type="submit" class="btn btn-blue">Сохранить</button>
          </div>
          <div class="product-container__create__description">
            <textarea class="edit-container__form__textarea" name="description">Текст поста</textarea>
          </div>
        </form>
      </div>
    </div>
