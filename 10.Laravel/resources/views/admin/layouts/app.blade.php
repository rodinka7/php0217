      ...
      <header class="main-header">
       @if (Route::has('login'))
        ...
        <nav class="main-navigation">
          <ul class="nav-list">
            <li class="nav-list__item"><a href="/admin" class="nav-list__item__link">Главная</a></li>
            <li class="nav-list__item"><a href="/orders" class="nav-list__item__link">Мои заказы</a></li>
            <li class="nav-list__item"><a href="/admin/posts" class="nav-list__item__link">Новости</a></li>
            <li class="nav-list__item"><a href="/admin/about" class="nav-list__item__link">О компании</a></li>
          </ul>
        </nav>
          ...
          <div class="sidebar-item">
            ...
            <div class="sidebar-item__content">
              <ul class="sidebar-category">
                ...
                <li class="sidebar-category__item"><a href="/admin/category/{{ $category->id }}" class="sidebar-category__item__link">{{ $category->name }}</a></li>
                @endforeach
              </ul>
            </div>
          </div>
            ...
            <div class="sidebar-item__content">
              ...
              @foreach ($posts as $post)
                <div class="sidebar-news__item">
                  ...
                  <div class="sidebar-news__item__title-news"><a href="/admin/posts/{{ $post->id }}" class="sidebar-news__item__title-news__link">{{ $post->name }}</a></div>
                </div>
              @endforeach
              </div>
            </div>
          ...
          <div class="random-product-container">
            ...
            <div class="random-product-container__content">
              <div class="item-product">
                <div class="item-product__title-product"><a href="/admin/good/{{ $random_good->id }}" class="item-product__title-product__link">{{ $random_good->name }}</a></div>
                <div class="item-product__thumbnail"><a href="/admin/good/{{ $random_good->id }}" class="item-product__thumbnail__link"><img src="/img/cover/{{ $random_good->image }}" alt="Preview-image" class="item-product__thumbnail__link__img"></a></div>
                <div class="item-product__description">
                  <div class="item-product__description__products-price"><span class="products-price">{{ $random_good->price }} руб</span></div>
                  <div class="item-product__description__btn-block"><a href="/admin/good/{{ $random_good->id }}" class="btn btn-blue">Редактировать</a></div>
                </div>
              </div>
            </div>
          </div>
