	...
	<?php if ( have_posts() ) :  while ( have_posts() ) : the_post(); ?>
	  <div class="content">
	    ...
	    <?php 
	    	...
	    	$prevPhoto = get_field('photo', $prevPost->ID);
	    ...
	    ?>
	      <div class="article-pagination__block pagination-prev-left"><a href="<?php echo get_permalink($prevPost->ID); ?>" class="article-pagination__link"><i class="icon icon-angle-double-left"></i>Предыдущая статья</a>
	        <div class="wrap-pagination-preview pagination-prev-left">
	          ...
	          <div class="preview-article__content">
	            <div class="preview-article__info"><a href="<?php echo get_permalink($prevPost->ID); ?>" class="post-date"><?php echo $prevPost->post_date; ?></a></div>
	  	...
	  	<?php 
	    	...
	    	$nextPhoto = get_field('photo', $nextPost->ID);

	    	if ($nextPost) :
	    ?>
	      <div class="article-pagination__block pagination-prev-right"><a href="<?php echo get_permalink($nextPost->ID); ?>" class="article-pagination__link">Следующая статья<i class="icon icon-angle-double-right"></i></a>
	        <div class="wrap-pagination-preview pagination-prev-right">
	          <div class="preview-article__img"><img src="<?php echo $nextPhoto['sizes']['thumbnail']; ?>" class="preview-article__image"></div>
	          <div class="preview-article__content">
	            <div class="preview-article__info"><a href="<?php echo get_permalink($nextPost->ID); ?>" class="post-date"><?php echo $nextPost->post_date; ?></a></div>
