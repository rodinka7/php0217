	...
	<?php if ( have_posts() ) :  while ( have_posts() ) : the_post(); ?>
	  <div class="content">
	    ...
	    <div class="article-pagination">
	      ...
	      <div class="article-pagination__block pagination-prev-right"><a href="<?php the_permalink(); ?>" class="article-pagination__link">Следующая статья<i class="icon icon-angle-double-right"></i></a>
